...
textrf<-function(...){
  div(
    ...
    fluidRow(column(12,
                    ...
                    p(icon("fas fa-exclamation-circle"),"Please visit their respective help pages (",actionLink("rfh","train"),"and",actionLink("rfh2","trainControl"),") for more details about the parameters available in menvi")
    ),
    column(12,
           htmlOutput("rfhelp")
    )))
